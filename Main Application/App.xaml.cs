...
namespace PrimeTube
{
    ...
    {
        private BackgroundDownloaderHelper bgDownloaderhelper;
        ...
        public App()
        {
            ...
            HockeyClient.Current.Configure(APIConstants.HockeyAppAPIKey);
#if DEBUG
        ...
        public BackgroundDownloaderHelper GetBackgroundDownloader()
        {
            return bgDownloaderhelper;
        }
